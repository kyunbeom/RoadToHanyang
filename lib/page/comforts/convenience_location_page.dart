...
class Convenience2 extends StatefulWidget {
  @override
  State<Convenience2> createState() => _Convenience2State();
}

class _Convenience2State extends State<Convenience2> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Marker> _markers = <Marker>[
      Marker(
          markerId: MarkerId("0"),
          position: SSG,
          infoWindow: InfoWindow(title: "신소재공학관", snippet: "B1층 (세븐일레븐)")),
      Marker(
          markerId: MarkerId("1"),
          position: LatLng(37.5579980, 127.046743),
          infoWindow: InfoWindow(title: "사자가 군것질 할때", snippet: "학술 정보관 앞 (세븐일레븐)")),
      Marker(
          markerId: MarkerId("2"),
          position: LatLng(37.558936, 127.047101),
          infoWindow: InfoWindow(title: "제1학생생활관", snippet: "1층 (CU)")),
      Marker(
          markerId: MarkerId("3"),
          position: IM,
          infoWindow: InfoWindow(title: "인문관", snippet: "B1층 (이마트24)")),
      Marker(
          markerId: MarkerId("4"),
          position: LatLng(37.559779, 127.049827),
          infoWindow: InfoWindow(title:"제 2학생생활관", snippet: "1층 (CU)")),
    ];
    Completer<GoogleMapController> _controller = Completer();
